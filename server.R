  ...
  designMatrix <- function(design, periods=NULL, clusters=NULL, file=NULL){
    if(design == "balanced"){
      ...
      if( clusters %% sequences != 0 ){
        stop("Must have equal number of clusters per sequence for design to be balanced. Enter a number of clusters that is divisible by the number of sequences (J-1), or upload a custom design via the 'Unbalanced' option.")
      }else{
